...
public final class TestCanopyClustering extends AbstractJob {

  private static final String DIRECTORY_CONTAINING_CONVERTED_INPUT = "data";

  private TestCanopyClustering() {
  }

  private static final Logger log = LoggerFactory.getLogger(TestCanopyClustering.class);

  public static void main(String[] args) throws Exception {
    if (args.length > 0) {
      log.info("Running with only user-supplied arguments");
      ToolRunner.run(new Configuration(), new TestCanopyClustering(), args);
    } else {
